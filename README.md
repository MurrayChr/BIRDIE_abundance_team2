...
#> the `.groups` argument.
#> [1] "Fitting state-space JAGS model at 2025-07-20 20:50:14.665332"
#> 
...
#> `summarise()` has grouped output by 'site_id', 'year'. You can override using
#> the `.groups` argument.
#> [1] "Fitting state-space JAGS model at 2025-07-20 20:50:34.471436"
#> 
#> Processing function input....... 
#> 
#> Done. 
